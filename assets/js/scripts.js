...
(function(){
    ...
    $('.javaDocLink').click(function(e) {
        e.preventDefault();
        if($('#javadoc').hasClass('none')) {
            $('#javadoc').removeClass('none');
            $('#javadoc').addClass('animated infinite fadeInDown');
        } else {
            $('#javadoc').removeClass('fadeInDown');
            $('#javadoc').addClass('fadeOutUp');
            setTimeout(
                function() {
                    $('#javadoc').removeClass('fadeOutUp');
                    $('#javadoc').addClass('none');
                }, 500);
        }
    });
